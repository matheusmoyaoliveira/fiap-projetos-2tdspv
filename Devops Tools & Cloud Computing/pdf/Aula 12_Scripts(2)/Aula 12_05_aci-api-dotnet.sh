...
az container create \
  ...
  --environment-variables \
    ConnectionStrings__DefaultConnection=$(az keyvault secret show --name connection-strings --vault-name $keyVaultName --query value -o tsv | sed "s/mysql-dimdim/$mysqlPublicIP/") \
